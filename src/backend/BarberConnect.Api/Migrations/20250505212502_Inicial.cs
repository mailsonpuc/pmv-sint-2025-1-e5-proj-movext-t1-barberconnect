    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HorarioDisponiveis", x => x.HorarioDisponivelId);
                    table.ForeignKey(
                        name: "FK_HorarioDisponiveis_Barbeiros_BarbeiroId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BarbeirosBarbeiroId = table.Column<int>(type: "INTEGER", nullable: false),
                    ServicosServicoId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarbeiroServico", x => new { x.BarbeirosBarbeiroId, x.ServicosServicoId });
                    table.ForeignKey(
                        name: "FK_BarbeiroServico_Barbeiros_BarbeirosBarbeiroId",
                        column: x => x.BarbeirosBarbeiroId,
                        principalTable: "Barbeiros",
                        principalColumn: "BarbeiroId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BarbeiroServico_Servicos_ServicosServicoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Agendamentos_HorarioDisponiveis_HorarioId",
                        column: x => x.HorarioId,
                        principalTable: "HorarioDisponiveis",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Avaliacoes_Barbeiros_BarbeiroId",
                        column: x => x.BarbeiroId,
                        principalTable: "Barbeiros",
                        principalColumn: "BarbeiroId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "HistoricoCortes",
                columns: table => new
                {
                    HistoricoCorteId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoCortes", x => x.HistoricoCorteId);
                    table.ForeignKey(
                        name: "FK_HistoricoCortes_Agendamentos_AgendamentoId",
                        column: x => x.AgendamentoId,
                        principalTable: "Agendamentos",
                        principalColumn: "AgendamentoId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BarbeiroServico_ServicosServicoId",
                table: "BarbeiroServico",
                column: "ServicosServicoId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoCortes_AgendamentoId",
                table: "HistoricoCortes",
                column: "AgendamentoId");

            migrationBuilder.CreateIndex(
                name: "IX_HorarioDisponiveis_BarbeiroId",
                table: "HorarioDisponiveis",
                column: "BarbeiroId");
        }
